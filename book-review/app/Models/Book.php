...
class Book extends Model
{
    ...
    //adding 2 new local query scopes inside book model the first one is called popular and it will get the books that have the most amount of reviews And 2nd one is called highest rated which means we would be sorting the books by the highest reviews average rating
    ...
    // tinker command line
    // items are first sorted by popular and then by highest rated
